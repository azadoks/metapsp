...
!rhov  all-electron valence charge
...
! override dpnint extrapolation to zero for vpl
 ...
 call dpnint(rr,rhov,mmax,rl,rhovl,nrl)
...
! write pseudo valence, all-electron valence and all-electron core charges
 do ii=1,nrl
   write(6,'(i6,1p,4e21.13)') ii,rl(ii),rhol(ii),rhovl(ii),rhocl(ii)
 end do
