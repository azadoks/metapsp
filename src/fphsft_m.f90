...
!
 subroutine fphsft_m(ll,epsh2,depsh,pshf,rr,vv,vtau,zz,mmax,mch,npsh,srel,ircmin)
...
!Input variables
 integer :: ll,mmax,npsh,mch,ircmin
...
!Local variables
 ...
 do ii = 1,npsh
   ...
   call lschfs_m(nn,ll,ierr,epsh,rr,vv,vtau,uu,up,zz,mmax,mch,srel,ircmin)
