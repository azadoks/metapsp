...
&           rr,vi,zz,mmax,iexc,etot,ierr,srel,ircmin)
...
!Input variables
 ...
 integer :: mmax,iexc,nc,ncv,ircmin
...
!Local variables
 integer :: nin,mch
 real(dp) :: amesh,al
 real(dp) :: dr,eeel,eexc,et,rl,rl1,sd,sf,sn,eeig,etot0,etot1,detot
 real(dp) :: thl,vn,zion
 integer :: ii,jj
 logical :: convg
...
!real(dp), parameter ::  eps=1.0d-12 ! etot convergence scale,etot0,etot1,detot
!real(dp), parameter ::  eps=1.0d-11 ! etot convergence scale,etot0,etot1,detot
 real(dp), parameter ::  eps=1.0d-10 ! etot convergence scale,etot0,etot1,detot
...
&                rr,vi,u,up,zz,mmax,mch,srel,ircmin)
     if(ierr .ne. 0) then
...
! output potential for e-e interactions write(6,*) 'sratom line 201',iexc ; flush 6
...
!   call vout(3,rho,rhoc,vo,vxc,sf-zz,eeel,eexc, &
!&            rr,mmax,4)
